...
int main(int argc, char** argv){
    ...
    ros::ServiceClient add_turtle = node.serviceClient<turtlesim::Spawn>("spawn");//turtle2
    //ros::ServiceClient add_turtle3 = node.serviceClient<turtlesim::Spawn>("spawn");//turtle3

	
	turtlesim::Spawn srv;//请求包括float32 x y theta，string name（可空），回应为string name
    add_turtle.call(srv);//请求turtle2
    add_turtle.call(srv);//请求turtle3
